...
**How it works:**
1. `model.predict(frame, conf=args.conf_threshold, ...)` — `conf=0.01` by default (effectively unfiltered as of 2026-08-16 — was `0.60`)
...
1. A dedicated detector thread (`AutoAcquireDetector` in
   ...
   mount commands.
2. Each cycle: same two filters as Raw (confidence /box filters effectively disabled by default as of 2026-08-16 (was confidence ≥0.60, box ≤10%)),
...
| Confidence floor | 0.70 | ~0 (disabled, 2026-08-16) | — | ~0 (disabled, 2026-08-16) |
